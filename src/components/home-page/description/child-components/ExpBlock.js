...
const ExpBlock = ({
  ...
  const handlejobPostionChange = (e) => {
    Vars.editingText(
      dispatch,
      e.target.value,
      `homePage/description/${indexOfHigherComponent}/childs/${_id}/jobPosition`,
      _id
    );
  };
  const handleCompanyInfoChange = (e) => {
    Vars.editingText(
      dispatch,
      e.target.value,
      `homePage/description/${indexOfHigherComponent}/childs/${_id}/companyInfo`,
      _id
    );
  };
  const handleYearsChange = (e) => {
    Vars.editingText(
      dispatch,
      e.target.value,
      `homePage/description/${indexOfHigherComponent}/childs/${_id}/years`,
      _id
    );
  };
  const handleMoreInfoChange = (e) => {
    Vars.editingText(
      dispatch,
      e.target.value,
      `homePage/description/${indexOfHigherComponent}/childs/${_id}/moreInfo`,
      _id
    );
  };
  ...
  return (
    <BlockModified width={width} className={className}>
      <EditableText
        width="100%"
        onChange={handlejobPostionChange}
        textAlign="left"
      ...
      <Block width="100%" flexbox={true}>
        ...
        />
        <Block width="7%">
          <Text width="100%" fontSize={Vars.FONT_SIZE_SM} textAlign="center">
            o
          </Text>
        </Block>
        <EditableText
