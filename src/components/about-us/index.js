...
const index = ({ width, className }) => {
  const image =
    "https://res.cloudinary.com/cachiengion314/image/upload/v1619718969/cv-image_jhl0qo.png";
  return (
    <div style={{ width: width, padding: "0 2rem" }} className={className}>
      <Text width="100%" textAlign="center" className="mt-4 mb-4">
        This website belong to hnam143
      </Text>
